...
{ IAVIFile *pfile;    // created by CreateAvi
  ...
  boolean iserr;         // if true, then no function will do anything
} TAviUtil;
...
AVI_FUNC
HRESULT SetAviVideoCompression(HAVI avi, HBITMAP hbm, AVICOMPRESSOPTIONS *opts, boolean ShowDialog, HWND hparent)
{ if (avi==NULL) return AVIERR_BADHANDLE;
