...
#define ID_MESSBAR	1919
#define ID_MESSSTATUSBAR 1920
...
//			hwndMessBar = CreateToolbarEx( hwnd, WS_CHILD|WS_VISIBLE, ID_MESSBAR, iMaxScan, hInst, SCANBARBMP, pScanbarButtons, iMaxScan, 16, 16, 16, 16, sizeof(TBBUTTON) );
			//|TBSTYLE_TOOLTIPS
			hwndMovieStatus = CreateStatusWindow( WS_CHILD|WS_BORDER|WS_VISIBLE, NULL, hwnd, ID_MESSSTATUSBAR);
//			iOn = IDM_MESS_SERIAL;
